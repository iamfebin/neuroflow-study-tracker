  ...
  return (
    <NeuroFlowProvider>
      <div className="bg-black text-mono-300 min-h-screen flex flex-col selection:bg-white selection:text-black">
        ...
        <Header onToggleSyncModal={toggleSyncModal} />

        {/* Dynamic Warning Alert Banner */}
        <CatchupBanner />

        {/* Main Interface Layout grid */}
        <main className="flex-grow max-w-6xl w-full mx-auto p-4 md:p-8 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
