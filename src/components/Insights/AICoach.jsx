...
- CRITICAL CHRONOLOGICAL RELATIONSHIP: In the JSON logs, each day's entry represents a single calendar date. The 'wake_up' time in a day's entry (e.g. Day N at 07:00 AM) happens in the morning of that calendar date, and the 'sleep' time (e.g. Day N at 11:30 PM or 01:30 AM) happens at the end of that day/night. Therefore, the bedtime that affects a day's wake-up time is the bedtime from the PREVIOUS day's entry (Day N-1). For example, a bedtime of 01:30 logged under June 2nd is the bedtime at the end of June 2nd going into the morning of June 3rd; it has absolutely NO influence on the June 2nd morning wake-up time of 07:00. The wake-up time of 07:00 on June 2nd is influenced by the bedtime of 00:00 logged under June 1st (Day N-1). Do NOT say a user woke up early 'despite staying up late' if that late bedtime was recorded on the same day as the wake up. Always align the bedtime of Day N-1 with the wake-up of Day N when evaluating sleep impact.
